...
export default function DistributorProfileScreen({ navigation }) {
    ...
    try {
      ...
      if (result) {
        Toast.show({
          ...
          text2: 'Distributor credentials have been saved.',
        });
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.headerBar, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={styles.headerTitleContainer}>
          <Text style={styles.headerTitle}>Distributor Profile</Text>
          <Text style={styles.headerSubtitle}>NGK WHOLESALE & SUPPLY</Text>
        </View>
      ...
      >
        ...
        <View style={styles.profileCard}>
          <View style={styles.profileCardTop}>
            ...
            <View style={styles.profileInfoCol}>
              <Text style={styles.profileName} numberOfLines={1}>
                {userName || 'Distributor Partner'}
              </Text>
              <View style={styles.roleRow}>
                <View style={styles.rolePill}>
                  <Text style={styles.rolePillText}>WHOLESALE DISTRIBUTOR</Text>
                </View>
          ...
          >
            ...
            <Text style={styles.editPillText}>Edit Hub Details</Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.pendingNoticeCard}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.pendingNoticeBody}>
                Your regional distributor account is currently being vetted by NGK administration. Once verified, your supply hub will automatically be activated on the live Authorized Stockists directory.
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeaderRow}>
            <Text style={styles.sectionHeader}>DISTRIBUTION HUB DETAILS</Text>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailTextWrapper}>
              <Text style={styles.detailLabel}>Hub Representative</Text>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailTextWrapper}>
              <Text style={styles.detailLabel}>Wholesale Email</Text>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailTextWrapper}>
              <Text style={styles.detailLabel}>Supply Chain Contact Phone</Text>
          ...
          {/* Warehouse / Hub Location Item */}
          <View style={styles.detailRow}>
            <View style={styles.detailIconWrapper}>
              <MapPin size={16} color="#4B5563" />
            </View>
            <View style={styles.detailTextWrapper}>
              <Text style={styles.detailLabel}>Warehouse Distribution Hub</Text>
        ...
        {/* Connected Services */}
        <View style={styles.sectionCard}>
          <Text style={styles.sectionHeader}>DISTRIBUTION SERVICES</Text>
          ...
          >
            ...
            <View style={styles.navTextCol}>
              <Text style={styles.navTitle}>Wholesale Inquiries & Dispatch</Text>
              <Text style={styles.navSubtitle}>
                {enquiriesCount} active orders & technical fulfillment requests
              </Text>
            </View>
        ...
        <Text style={styles.footerNote}>
          NGK SPARK PLUGS (PTY) LTD • WHOLESALE DISTRIBUTOR NETWORK
        </Text>
      </ScrollView>
          ...
          >
            ...
            <View style={styles.modalHeader}>
              <View>
                ...
                <Text style={styles.modalSubtitle}>
                  Update contact & warehouse facility address
                </Text>
              </View>
              <TouchableOpacity
            ...
            >
              ...
              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Hub Representative</Text>
              ...
              {/* Email Field */}
              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Wholesale Email</Text>
                <View style={styles.inputWrapper}>
              ...
              {/* Hub / Location Field */}
              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Warehouse Distribution Hub</Text>
